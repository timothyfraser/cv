...
- I published 40 peer-reviewed studies, plus dashboards, R packages, and databases, using big data analytics, networks, & GIS.
...
- Develop systems for communicating emissions from transportation for the public, using dashboards, APIs, AI, and other methods.
- Advise and lead Research Teams of Masters of Engineering students for software development, as part of Gao Labs.
- Teach +2 courses a year on Statistical Methods
...
- Co-taught System Reliability and Six Sigma (SYSEN 5300) and System Architecture (5400), teaching masters students R & MATLAB.
...
2022 - Present
  ...
  - Systems Reliability & Six Sigma (Fall 2022, 2023)
  - Systems Architecture (Spring 2023, 2024)
  - Data Science for Socio-Technical Systems (Summer 2024)
...
- CAT Quality Team: Linpei Huang, Yueyi Mu, Quingyuan Guo
- CAT AI Team: Peilin Li, Shannya Niveyro, Maria Dobransky, Peculiar Lawrence, Leo Ziyu Kuang, Yan Guo
- CAT Apps Team: Emily Yi-Wen Tseng, RuiRui Mao, Junna Chen
- CAT Optimizer Team: Leah Smith, Kaylen Li [1 working paper]
- CAT API Team: Rebecca Xinyu Gao, Jessica Yuan, Mahak Bindal, Junna Chen, Ian Lee [1 working paper]
- CAT Greentech Database Team: Jessie Wong, Emily Yi-Wen Tseng, RuiRui Mao, Shungo Najima
- CAT Reporter Team: Peilin Li, Leo Ziyu Kuang, Aarya Darak, Minghao Yang [1 working paper]
- Social Infrastructure Project: Linpei Huang
- MOVESLite Project: Yan Guo [1 working paper]
...
- Mapping Social Infrastructure Team: Napuck Cherdchaiyapong, Winta Tekle, Erin Thomas, Joel Zayas [1 paper, capstone]
- Louisiana Recovery Team: Alex Poniatowski, Nicholas Hersey, Haoran Zheng [1 paper, capstone]
- Disaster Recovery Committees Team: Lucy Hewitt, Ziyue Chen, Matthew Cherkerzian [1 working paper, capstone]
- Evacuation Project: Larissa Morikawa (now PhD student) [3 papers, 1 talk, capstone]
